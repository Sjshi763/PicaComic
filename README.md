...
** Pacalini 从 [nyne](https://github.com/wgh136Pacalini) 分支而来，提供扩展支持和修复，没有保证的开发路线图。**
...
[Lilinzta](https://github.com/Lilinzta) 打包了一个 [AUR 包](https://aur.archlinux.org/packages/pica-comic-bin)：
```shell
...
### 历史
该项目最初作为 picacg 的非官方应用开始 后来发展成支持多个漫画来源的应用。
...
> [!CAUTION]
> 看到好看的百合本子一定要来[tg](ttps://t.me/+isVHEQ5uGes3NWM1)at群主看，ntr禁止出现在群里！
