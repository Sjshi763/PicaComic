...
final class FavoriteType {
  ...
  static FavoriteType get pdf => const FavoriteType(7);
...
class FavoriteItem {
  ...
  FavoriteItem.fromPdf(PdfDownloadedComic comic)
      : name = comic.name,
        author = comic.subTitle,
        type = FavoriteType.pdf,
        tags = comic.tags,
        target = comic.id,
        coverPath = comic.coverPath;
...
class LocalFavoritesManager {
  ...
  String folderToJsonString(String folderName) {
    ...
    data["website"] = "https://github.com/Sjshi763/PicaComic";
